      ...
      <div className="container">
        ...
        <form onSubmit={getArticle} className='mb-3'>
          ...
          <div className="form-check">
            <input className="form-check-input" type="checkbox" value="html" id="html" onChange={e => setHtml(e.target.checked ? "html" : "")} />
            <label className="form-check-label" htmlFor="html">
              Html
            </label>
          </div>
          <div className="form-check">
            <input className="form-check-input" type="checkbox" value="js" id="js" onChange={e => setJs(e.target.checked ? "js" : "")} />
